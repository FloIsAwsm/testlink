...
class TCPDF {
	...
	/**
	 * Sets the current active configuration setting of magic_quotes_runtime (deprecated, no longer has any effect in PHP 7.4+)
	 * @param boolean $mqr FALSE for off, TRUE for on.
	 * @since 4.6.025 (2009-08-17)
	 */
	public function set_mqr($mqr) {
		// Magic quotes runtime is always disabled in PHP 7.4+, this function has no effect
	}

	/**
	 * Gets the current active configuration setting of magic_quotes_runtime (deprecated, always returns 0 in PHP 7.4+)
	 * @return Returns 0 as magic quotes runtime is always disabled in PHP 7.4+
	 * @since 4.6.025 (2009-08-17)
	 */
