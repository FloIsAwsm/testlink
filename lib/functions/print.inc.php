...
function renderFirstPage($doc_info)
{
  ...
  //
  $output .= '<div class="doc_title" style="margin-top: 15%;margin-left:200px"><img src="http://rndpdweb01:8100/testlink/gui/themes/default/SWARCO.GIF" alt="SWARCO FUTURIT" title="" height="80px" style="position:absolute;top:50px;right:30px;"><p>' . $doc_info->type_name . '</p>' . "</div>\n";
  $output .= '<div class="doc_titleSmall" style="margin-left:200px" ><p>PRODUCT: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font style="font-weight:normal;">' . lang_get('testproject') . ": " . $doc_info->tproject_name . 
			'</font>'.
			'<br>REPORT GENERATED: &nbsp; <font style="font-weight:normal;">' . strftime($date_format_cfg, time()) . 
			'</font><br>RELEASE DATE: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <font style="font-weight:normal;">see test execution dates'.
			'</font><br>VERSION: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <font style="font-weight:normal;">1.0'.
			'</font><br>AUTHOR: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="font-weight:normal;">Thomas Ofner-Svatik'.
			'</font><br>APPROVED:  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="font-weight:normal;">Armin Peter</p> ';
  ...
  {
    $output .= '</font><br>' . lang_get('testplan') . ': &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="font-weight:normal;">' . $doc_info->testplan_name .'</font>';
  }  

  if($doc_info->type == DOC_TEST_PLAN_EXECUTION_ON_BUILD)
  {
    $output .= '<br>' . lang_get('build') . ': &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="font-weight:normal;">' . $doc_info->build_name .'</font>';
  }  
  ...
  $output .= '<font style="font-weight:normal;"><br><br><br>This document is the exclusive property of SWARCO FUTURIT Verkehrssignalsysteme Ges.m.b.H.<br> and cannot be reproduced or circulated unless expressly authorised.</font>' ;
  
  
  $output .= '' . "</div>\n" . "\n<div class=\"firstfooter\">" . 
			'<p><b>SWARCO FUTURIT Verkehrssignalsysteme GmbH</b><br>Manfred-Swarovski-Strasse 1<br>A-7343 Neutal<br>TEL.: +43-2618-200 25-0<br>FAX: +43-2618-200 25-50<br>URL: www.swarco.com</p>' . 
			"\n</div>\n</div>\n";
